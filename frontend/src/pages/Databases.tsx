...
const COLUMNS: CIColumnDef<Databases>[] = [
  ...
  { key: 'size_gb',           header: 'Size (GB)',                  type: 'number' },
  ...
  { key: 'monitoring',        header: 'Monitoring (SIEM)',          type: 'boolean',width: 120 },
  ...
  return (
    <CITable<Databases, DatabasesPayload>
      ...
      booleanFields={['backup_enabled', 'encryption_at_rest', 
                      'tde_enabled', 'access_control', 'monitoring'
                    ]}
