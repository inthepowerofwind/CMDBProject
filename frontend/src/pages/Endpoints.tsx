...
const COLUMNS: CIColumnDef<Endpoints>[] = [
  ...
  { key: 'department',        header: 'Department',                 type: 'select', width: 120, options: ['IT', 'Finance', 'Marketing', 'Operations', 'HR', 'Sales', 'Development', 'Executive'] },
  { key: 'location_floor',    header: 'Location / Floor',           type: 'text',   width: 160 },
  ...
  { key: 'ram_gb',            header: 'RAM (GB)',                   type: 'number' },
  { key: 'storage_gb',        header: 'Storage (GB)',               type: 'number' },
